...
(function($) {
  $.fn.tweet = function(o){
    var s = $.extend({
      username: "mashoutable",                           // [string or array] required unless using the 'query' option; one or more twitter screen names (use 'list' option for multiple names, where possible)
      ...
      comparator: function(tweet1, tweet2) {    // [function] comparator used to sort tweets (see Array.sort)
        return tweet2["tweet-time"] - tweet1["tweet-time"];
      },
    ...
    return this.each(function(i, widget){
      var list = $('<ul class="tweet-list">').appendTo(widget);
